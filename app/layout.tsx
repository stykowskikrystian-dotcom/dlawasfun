...
const seoDescription = "Fotobudka 360 i DJ na imprezę na Mazurach oraz w całej Polsce. Obsługujemy wesela, eventy i imprezy firmowe. Poznaj ofertę dlawas.fun.";

const nationwideServiceAreas = [
  "Polska",
  "Mazury",
  "Giżycko",
  "Mikołajki",
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "fotobudka 360 Olsztyn",
    "fotobudka 360 Szczecin",
    "fotobudka 360 Kraków",
    "fotobudka 360 Warszawa",
    "fotobudka 360 Białystok",
    "fotobudka 360 Suwałki",
    "fotobudka 360 Toruń",
    "DJ na imprezę Olsztyn",
    "DJ na imprezę Warszawa",
